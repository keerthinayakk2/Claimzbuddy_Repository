...
beforeEach(function(){
  ...
  describe('InsuredLogin Test', () => {
    it('Insured', () => {
      ...
      insuredPage.enterPolicyHolder('Seema Nayak')
...
insuredPage.searchForInsured('Seema Nayak')
...
insuredLoginPage.enterPolicyNumber('81974')
...
// Login as admin
    ...
    insuredLoginPage.policyDetails('81974')
    insuredLoginPage.enterPolicyNum('81974')
    insuredLoginPage.enterPolicyType('ALL RISK POLICY')
    insuredLoginPage.selectInsurer('HDFC')
    // insuredLoginPage.selectPolicyHolder('Seema Nayak')
    ...
    // insuredLoginPage.enterPolicyDetails('81974')
