...
beforeEach(function(){
  ...
  describe('InsuredLogin Test', () => {
    it('Insured', () => {
      ...
      insuredPage.enterPolicyHolder('Smitha Nayak')
...
insuredPage.searchForInsured('Smitha Nayak')
...
insuredLoginPage.enterPolicyNumber('81024')
...
// Login as admin
    ...
    insuredLoginPage.policyDetails('81024')
    insuredLoginPage.enterPolicyNum('81024')
    insuredLoginPage.enterPolicyType('ALL RISK POLICY')
    insuredLoginPage.selectInsurer('HDFC')
    // insuredLoginPage.selectPolicyHolder('Smitha Nayak')
    ...
    // insuredLoginPage.enterPolicyDetails('81024')
