...
beforeEach(function(){
  ...
  describe('InsuredLogin Test', () => {
    it('Insured', () => {
      ...
      insuredPage.enterPolicyHolder('Chinthana Nair')
...
insuredPage.searchForInsured('Chinthana Nair')
...
insuredLoginPage.enterPolicyNumber('80737')
...
// Login as admin
    ...
    insuredLoginPage.policyDetails('80737')
    insuredLoginPage.enterPolicyNum('80737')
    insuredLoginPage.enterPolicyType('ALL RISK POLICY')
    insuredLoginPage.selectInsurer('HDFC')
    // insuredLoginPage.selectPolicyHolder('Chinthana Nair')
    insuredLoginPage.selectInsuredAmount('50000')
    insuredLoginPage.selectLineOfBusiness('MOTOR')
    insuredLoginPage.selectStartDate('1-march-2024')
    insuredLoginPage.selectEndtDate('29-march-2024')
    insuredLoginPage.selectDuration('28')
    insuredLoginPage.createPolicy()
    // insuredLoginPage.enterPolicyDetails('80737')
