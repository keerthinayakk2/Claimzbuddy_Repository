...
beforeEach(function(){
  ...
  describe('InsuredLogin Test', () => {
    it('Insured', () => {
      ...
      insuredPage.enterPolicyHolder('Rithika Rao')
...
insuredPage.searchForInsured('Rithika Rao')
...
insuredLoginPage.enterPolicyNumber('99123')
...
// Login as admin
    ...
    insuredLoginPage.policyDetails('99123')
    insuredLoginPage.enterPolicyNum('99123')
    insuredLoginPage.enterPolicyType('ALL RISK POLICY')
    insuredLoginPage.selectInsurer('HDFC')
    // insuredLoginPage.selectPolicyHolder('Rithika Rao')
    ...
    // insuredLoginPage.enterPolicyDetails('99123')
