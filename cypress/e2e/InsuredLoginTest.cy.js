...
beforeEach(function(){
  ...
  describe('InsuredLogin Test', () => {
    it('Insured', () => {
      ...
      insuredPage.enterPolicyHolder('Ganesh K')
...
insuredPage.searchForInsured('Ganesh K')
...
insuredLoginPage.enterPolicyNumber('777007')
...
// Login as admin
    ...
    insuredLoginPage.policyDetails('777007')
    insuredLoginPage.enterPolicyNum('777007')
    insuredLoginPage.enterPolicyType('ALL RISK POLICY')
    insuredLoginPage.selectInsurer('HDFC')
    // insuredLoginPage.selectPolicyHolder('Ganesh K')
    ...
    // insuredLoginPage.enterPolicyDetails('777007')
