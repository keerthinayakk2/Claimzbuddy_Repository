...
beforeEach(function(){
  ...
  describe('InsuredLogin Test', () => {
    it('Insured', () => {
      ...
      insuredPage.enterPolicyHolder('Chetan Naik')
...
insuredPage.searchForInsured('Chetan Naik')
...
insuredLoginPage.enterPolicyNumber('661')
...
// Login as admin
    ...
    insuredLoginPage.policyDetails('661')
    insuredLoginPage.enterPolicyNum('661')
    insuredLoginPage.enterPolicyType('ALL RISK POLICY')
    insuredLoginPage.selectInsurer('HDFC')
    // insuredLoginPage.selectPolicyHolder('Chetan Naik')
    ...
    // insuredLoginPage.enterPolicyDetails('661')
