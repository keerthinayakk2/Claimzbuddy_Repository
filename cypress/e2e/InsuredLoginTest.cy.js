...
beforeEach(function(){
  ...
  describe('InsuredLogin Test', () => {
    it('Insured', () => {
      ...
      insuredPage.enterPolicyHolder('Kumar Nayak')
...
insuredPage.searchForInsured('Kumar Nayak')
...
insuredLoginPage.enterPolicyNumber('767612')
...
// Login as admin
    ...
    insuredLoginPage.policyDetails('767612')
    insuredLoginPage.enterPolicyNum('767612')
    insuredLoginPage.enterPolicyType('ALL RISK POLICY')
    insuredLoginPage.selectInsurer('HDFC')
    // insuredLoginPage.selectPolicyHolder('Kumar Nayak')
    ...
    // insuredLoginPage.enterPolicyDetails('767612')
